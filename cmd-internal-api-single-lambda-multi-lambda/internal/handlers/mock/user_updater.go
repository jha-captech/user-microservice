...
func (_m *MockUserUpdater) UpdateUser(ID int, user models.User) (models.User, error) {
...
//   - ID int
//   - user models.User
func (_e *MockUserUpdater_Expecter) UpdateUser(ID interface{}, user interface{}) *MockUserUpdater_UpdateUser_Call {
	return &MockUserUpdater_UpdateUser_Call{Call: _e.mock.On("UpdateUser", ID, user)}
}

func (_c *MockUserUpdater_UpdateUser_Call) Run(run func(ID int, user models.User)) *MockUserUpdater_UpdateUser_Call {
...
func (_c *MockUserUpdater_UpdateUser_Call) RunAndReturn(run func(int, models.User) (models.User, error)) *MockUserUpdater_UpdateUser_Call {
	_c.Call.Return(run)
	return _c
}
